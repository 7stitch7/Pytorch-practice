...
train_data = torchvision.datasets.MNIST(
    root = './minist/',
    train = True,
    transform = torchvision.transforms.ToTensor(),   # convert a PIL.image into numpy array
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(     # input shape (1,28,28)
            nn.Conv2d(
                in_channels=1,          # input number of channels
                out_channels=16,        # n_filter, number of filters
